    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="min-h-screen flex items-center justify-center px-8">
        <div className="text-center max-w-3xl">
          <h1 className="text-7xl lg:text-9xl font-light tracking-tight leading-[0.95] mb-8">
            Your skin
            <br />
            <span className="font-normal">decoded</span>
        </h1>
          
          <p className="text-xl text-gray-600 leading-relaxed font-light mb-12 max-w-2xl mx-auto">
